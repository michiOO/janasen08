...
//		System.out.println(judge[GOO][PAA]);
		boolean flag = true;
		while (flag) {
			int ret1 = UedaFighter.getTe();
			int ret2 = UedaFighter.getTe();
			System.out.println("ちだ1さんが" + te[ret1]);
			System.out.println("ちだ2さんが" + te[ret2]);
			switch (judge[ret1][ret2]) {
				...
				case KACHI_1:
					flag = false;
					System.out.println("ちだ1の勝ち");
					break;
				case KACHI_2:
					flag = false;
					System.out.println("ちだ2の勝ち");
					break;
			}
		}
	}
